---
title: Changelog
description: Release history and changes for libdogecoin.
---
...
* Setting fixed size for priv and pubkeys in generatePrivPubKeypair and by @DrinoSan in https://github.com/dogecoinfoundation/libdogecoin/pull/34
