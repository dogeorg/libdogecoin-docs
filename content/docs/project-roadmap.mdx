...
description: Planned stages and roadmap for libdogecoin development.
---
...
*Stage diagrams (e.g. `public/diagrams/libdogecoin-stage1.png`) can be added when available.*
