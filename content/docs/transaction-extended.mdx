---
title: Transaction (Extended)
description: Extended transaction structure and low-level details.
---
...
*The examples above were derived from [https://en.bitcoin.it](https://en.bitcoin.it).*
